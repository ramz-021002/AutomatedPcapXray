...
class pcapXrayCLI():
    def __init__(self):
        self.pcap_file = '/Users/ramz/Downloads/Project/zeek/capture.pcap'
        self.destination_report = '/Users/ramz/Downloads/Project/Module/Report'
